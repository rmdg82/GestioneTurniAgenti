...
namespace GestioneTurniAgenti.Server.Migrations
{
    ...
    [Migration("20210821201810_AddUniqueIndexAgentiMatricola")]
    partial class AddUniqueIndexAgentiMatricola
    {
            ...
            modelBuilder.Entity("GestioneTurniAgenti.Server.Entities.Agente", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c6f798ed-211e-4c5e-8855-c7512bc66839"),
                            Cognome = "Rossi",
                            Matricola = "123456AB",
                            Nome = "Mario",
                        ...
                        new
                        {
                            Id = new Guid("c4a4a55e-8d1a-4f05-8312-61b884a7fb38"),
                            Cognome = "Bianchi",
                            Matricola = "789012CD",
                            Nome = "Antonio",
                            RepartoId = new Guid("7f2fb853-4aab-43d3-9448-d9f3edbc793c")
                        ...
                        new
                        {
                            Id = new Guid("82b11398-e693-496a-862b-9e3a32988aa0"),
                            Cognome = "Verdi",
                            Matricola = "135267EF",
                            Nome = "Pietro",
                        ...
                        new
                        {
                            Id = new Guid("ca0d2a00-fdf1-4117-872b-19f537c59d39"),
                            Cognome = "Blu",
                            Matricola = "564922HJ",
                            Nome = "Antonio",
                        ...
                        new
                        {
                            Id = new Guid("5e1a47a0-af23-4de8-b773-75ab5db73e9c"),
                            Cognome = "Viola",
                            Matricola = "789012FG",
                            Nome = "Paolo",
                            RepartoId = new Guid("7307b34f-052c-4ef1-b0c3-fb6b3ffe8f3f")
